"""
Django settings for still_bar_dev_98772 project.
...
ROOT_URLCONF = 'still_bar_dev_98772.urls'
...
WSGI_APPLICATION = 'still_bar_dev_98772.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_bar_dev_98772 API",
    "DESCRIPTION": "API documentation for still_bar_dev_98772 App",
    "VERSION": "v1",
}
